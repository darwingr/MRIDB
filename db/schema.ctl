...
(
    ...
    first_name              VARCHAR22(20)        NOT NULL,
    last_name               VARCHAR22(20)        NOT NULL
);
...
(
    id                      NUMBER(12)        NOT NULL    unique,
    technician_notes        VARCHAR22(1000),
...
(
    ...
    physician_notes         VARCHAR22(2000),
...
(
    ...
    physician_notes         VARCHAR22(4000),
...
(
    id                      NUMBER,
    label                   VARCHAR22(50)     NOT NULL,
    brain_region            VARCHAR22(20)
);
...
(
    id                      NUMBER(5)         NOT NULL    unique,
    name                    VARCHAR22(50)      NOT NULL    unique,
    signs                   VARCHAR22(100),
    symptoms                VARCHAR22(4000)
);
...
(
    id                      NUMBER(5)         NOT NULL    unique,
    manufacturer            VARCHAR22(100),
    model_number            VARCHAR22(25),
...
(
    ...
    first_name              VARCHAR22(20)      NOT NULL,
    last_name               VARCHAR22(20)      NOT NULL,
    specialty               VARCHAR22(100)      NOT NULL
);
...
(
    ...
    email                   VARCHAR22(50)      NOT NULL    unique,
    first_name              VARCHAR22(20)      NOT NULL,
    last_name               VARCHAR22(20)      NOT NULL,
