...
ALTER TABLE visits
    ...
    ADD CONSTRAINT FK_Patient_Number FOREIGN KEY(patient_number) REFERENCES patients(id);
...
ALTER TABLE diagnoses
    ...
    ADD CONSTRAINT FK_Patient_Num FOREIGN KEY(patient_number) REFERENCES patients(id)
