...
public class OracleDBAdapter implements DBAdapter {
	 ...
	 * 
	 * SIDE EFFECTS:
	 *   all env vars are set, final statics on OracleDBAdapter class
	 *   DB_URL is set
	 */
	public static boolean checkEnvironment() {
	    ...
	    for (String name : var_names){
	        ...
	        try {
	            Class<OracleDBAdapter> aClass = OracleDBAdapter.class;
	            ...
	            if (env_var.get(null) == null || "".equals(env_var.get(null))) {
	        		...
	        		String de = "Missing declaration error: expected " + name + " to be declared on OracleDBAdapter.";
	 ...
	 *
	 */
	public OracleDBAdapter() throws SQLException {
